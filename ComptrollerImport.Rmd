...
c1data<-apply_lookups(Path,c1data)
...
m1data<-apply_lookups(Path,m1data)
...
o1data<-apply_lookups(Path,o1data)
...
rf1data<-apply_lookups(Path,rf1data)


ddply(rf1data,
      .(Account,Account.Title,Organization),
      plyr::summarise,
      FY.2014..Base...OCO.=sum(FY.2014..Base...OCO.)
      )
