...
c1sum<-ddply(c1data,
      .(Account,MilDeptDW,AccountTitle,Organization,Fiscal.Year,BudgetType,variable),
      plyr::summarise,
      value=sum(value)
      )
...
rf1data<-ComptrollerMelt(rf1data)
...
Procurement<-ComptrollerMelt(Procurement)
